...
fun numberRevert(number: Int): Int {
    val leastDigit = number / 100
    val middleDigit = ((number / 10) % 10) * 10
    val seniorDigit = (number % 10) * 100
    return seniorDigit + middleDigit + leastDigit
}
