 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes*0.04445*48) + (arshins*0.04445*16) + (vershoks*0.04445)
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val r = 1 + percent / 100.0
    val res = initial * (r * r * r)
    return res
}
